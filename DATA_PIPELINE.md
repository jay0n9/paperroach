...
If a managed block has no markers yet, the updater appends a fresh block where
safe. If markers are partial, duplicated, or out of order, the updater skips the
